...
const navigationHTML = `<nav class="navbar" id="navbar"><div class="container nav-container"><div class="logo"><a href="index.html"><img src="images/igfm-logo.png" alt="IGFM Logo" class="logo-image"><div class="logo-text"><h2>IGFM</h2><span>International Great Faith Ministries</span></div></a></div><ul class="nav-menu" id="nav-menu">
